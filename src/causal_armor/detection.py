...
def detect_dominant_spans(
    ...
    A span is flagged when its normalized attribution exceeds the user's
    normalized attribution minus the margin threshold::

        flagged if: delta_S_normalized > delta_U_normalized - tau
